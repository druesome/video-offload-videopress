	...
	public static function enqueue_assets( string $hook ): void {
		...
		wp_localize_script( 'vov-admin', 'vovData', array(
			...
			'strings' => array(
				...
				'confirmReplace' => __( 'This will update all post content to use the VideoPress embed instead of the local video URL. This action cannot be undone.', 'video-offload-videopress' ),
				...
				'usedInNote'     => __( 'Results include post content, Elementor, and Beaver Builder. Replace in Content only updates standard post content — videos embedded via page builders must be swapped manually.', 'video-offload-videopress' ),
			),
		) );
	}
	...
	public static function render_status_cell( int $attachment_id, array $s ): void {
		...
		switch ( $status ) {
			...
			case Offloader::STATUS_UPLOADED:
				echo '<span class="vov-badge vov-badge--uploaded">'
					. '<svg class="vov-vp-icon" viewBox="0 0 25 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">'
					. '<path d="M19.2 3H5.8C4.5 3 3.5 4 3.5 5.3V18.7C3.5 20 4.5 21 5.8 21H19.2C20.5 21 21.5 20 21.5 18.7V5.3C21.5 4 20.5 3 19.2 3ZM20 18.7C20 19.1 19.6 19.5 19.2 19.5H5.8C5.4 19.5 5 19.1 5 18.7V5.3C5 4.9 5.4 4.5 5.8 4.5H19.2C19.6 4.5 20 4.9 20 5.3V18.7ZM10.5 15L15.5 12L10.5 9V15Z"/>'
					. '</svg>'
					. esc_html__( 'On VideoPress', 'video-offload-videopress' )
					. '</span>';
